...
public interface ConfigReader {
	...
	void updateGeofences() throws IOException;

	void updateGroupFilterWithMons() throws IOException;

	void updateGroupFilterWithIV() throws IOException;

	void updateGroupFilterWithRaidMons() throws IOException;
